...
public class ModuleIOSparkMax implements ModuleIO {
  ...
  private static final double DRIVE_GEAR_RATIO = Constants.Swerve.DRIVE_GEAR_RATIO;
  private static final double TURN_GEAR_RATIO = Constants.Swerve.TURN_GEAR_RATIO;
  ...
  public ModuleIOSparkMax(int index) {
    switch (index) {
      ...
      case 1: // FRONT RIGHT
        ...
        turnAbsoluteEncoder = new AnalogInput(PortMap.Swerve.ABSOLUTE_ENCODER_FR);
        // 180 - 3.141592
        // 90 - 3.141592 / 2
        // 1 - 0.01745
  ...
  public void setDriveVoltage(double volts) {
    driveSparkMax.setVoltage(volts / 6); // TODO testing if turn jerks still with low Volts
  }

  @Override
  public void setTurnVoltage(double volts) {
    turnSparkMax.setVoltage(volts / 6); // TODO testing if turn jerks still with low Volts
  }
